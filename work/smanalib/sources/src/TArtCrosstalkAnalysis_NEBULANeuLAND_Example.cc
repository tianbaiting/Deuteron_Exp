...
TArtCrosstalkAnalysis_NEBULANeuLAND_Example::TArtCrosstalkAnalysis_NEBULANeuLAND_Example()
...
//_____________________________________________________________________________
void TArtCrosstalkAnalysis_NEBULANeuLAND_Example::Analyze(){
...
//_____________________________________________________________________________
void TArtCrosstalkAnalysis_NEBULANeuLAND_Example::KillInvalidHit(){
...
//_____________________________________________________________________________
void TArtCrosstalkAnalysis_NEBULANeuLAND_Example::KillCrosstalk(){
  int npla = fNEBULAPlaArray->GetEntries();
...
//_____________________________________________________________________________
void TArtCrosstalkAnalysis_NEBULANeuLAND_Example::CheckCrosstalk(){
  int npla = fNEBULAPlaArray->GetEntries();
...
//_____________________________________________________________________________
Bool_t TArtCrosstalkAnalysis_NEBULANeuLAND_Example::IsCrosstalk(TArtNEBULAPla *pla1, TArtNEBULAPla *pla2)
{
...
//      if ( fabs(fabs(beta12inv)-1.0)<3.0*0.2393 && q2<15 ) return true;
      ...
      std::cout<<"TArtCrosstalkAnalysis_NEBULANeuLAND_Example: Strange DetectorName"<<std::endl;
    }
    ...
    Double_t br = beta01*beta12inv;
    Double_t q1_calc = (100-0)/(1.2-0.8)*(br-0.8);
    if ( q1 < q1_calc ) return true;

    // kill gamma events
    if (fabs(fabs(beta12inv)-1)< 3*0.1267 && q2<15 ) return true;

    // temp 
    if (beta12inv<-3) return true;
