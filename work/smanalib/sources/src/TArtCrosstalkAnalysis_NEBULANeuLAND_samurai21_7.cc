#include "TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7.hh"
#include "TArtCore.hh"

//_____________________________________________________________________________
TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7::TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7()
...
//_____________________________________________________________________________
void TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7::Analyze(){
...
//_____________________________________________________________________________
void TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7::KillInvalidHit(){
...
//_____________________________________________________________________________
void TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7::KillCrosstalk(){
  int npla = fNEBULAPlaArray->GetEntries();
...
//_____________________________________________________________________________
void TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7::CheckCrosstalk(){
  int npla = fNEBULAPlaArray->GetEntries();
...
//_____________________________________________________________________________
Bool_t TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7::IsCrosstalk(TArtNEBULAPla *pla1, TArtNEBULAPla *pla2)
{
...
//      if ( fabs(fabs(beta12inv)-1.0)<3.0*0.2393 && q2<15 ) return true;
      ...
      std::cout<<"TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7: Strange DetectorName"<<std::endl;
    }
    ...
    if ( (pla1->GetLayer()==1 && pla2->GetLayer()==2) || 
	 (pla1->GetLayer()==2 && pla2->GetLayer()==1) ){
      ...
      if (fabs(fabs(beta12inv)-1)< 3*0.0410261 && q2<15 ) return true;// kill gamma events

    }else if  ( (pla1->GetLayer()==1 && pla2->GetLayer()==3) || 
		(pla1->GetLayer()==3 && pla2->GetLayer()==1) ){

      if (br>1.035) return true;
      if (fabs(fabs(beta12inv)-1)< 3*0.0238960 && q2<15 ) return true;// kill gamma events
      ...
      if (br>1) return true;
      if (fabs(fabs(beta12inv)-1)< 3*0.1267 && q2<15 ) return true;// kill gamma events

    }else{
      std::cout<<"TArtCrosstalkAnalysis_NEBULANeuLAND_samurai21_7: unknown Layer combination "
