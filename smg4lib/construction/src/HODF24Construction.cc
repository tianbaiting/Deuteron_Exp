...
HODF24Construction::HODF24Construction()
    ...
    fHODScinti_log(0)
{
  ...
  new HODF24ConstructionMessenger(this);
}
//______________________________________________________________________________________
HODF24Construction::~HODF24Construction()
{;}
//______________________________________________________________________________________
G4VPhysicalVolume* HODF24Construction::Construct()
{
...
//______________________________________________________________________________________
G4LogicalVolume* HODF24Construction::ConstructSub()
{
