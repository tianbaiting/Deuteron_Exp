...
HODSConstruction::HODSConstruction()
  : fPosition(0, 0, 5500*mm),
    ...
    fHODScinti_log(0)
{
  ...
  new HODSConstructionMessenger(this);
}
//______________________________________________________________________________________
HODSConstruction::~HODSConstruction()
{;}
//______________________________________________________________________________________
G4VPhysicalVolume* HODSConstruction::Construct()
{
...
//______________________________________________________________________________________
G4LogicalVolume* HODSConstruction::ConstructSub()
{
  ...
  G4double hod_y = 500*0.5*mm;
  G4double hod_z = 5*0.5*mm;
