#include "TDALISimData.hh"

#include <iostream>
#include <algorithm>
#include <iterator>

ClassImp(TDALISimData)
TDALISimDataArray* gDALISimDataArray = 0;
//____________________________________________________________________
std::ostream& operator<<(std::ostream& out, const TDALISimData& data)
{
